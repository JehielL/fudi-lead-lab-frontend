...
export class MainLayout implements OnInit {
  ...
  readonly navItems: NavItem[] = [
    ...
    { label: 'Duplicates', path: '/duplicates', icon: 'M7 7h7v2H7v3l-4-4 4-4v3Zm10 10h-7v-2h7v-3l4 4-4 4v-3ZM8 14a4 4 0 0 0 7.45 2H13v-2h6v6h-2v-2.35A6 6 0 0 1 6 14h2Zm8-4a4 4 0 0 0-7.45-2H11v2H5V4h2v2.35A6 6 0 0 1 18 10h-2Z' },
